"""
Migration metrics for the 2nd-upload batch (generalisation test).
Same logic as extract_migration_finetuned.py, just different paths.
"""
import csv
import json
...
print(f'[setup] {len(manifest)} cells (2nd batch)')
...
print('\n=== Per-condition summary (2nd batch, filter applied) ===')
