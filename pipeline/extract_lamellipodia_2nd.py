"""
Lamellipodia / cytoplasm metrics for the 2nd-upload batch (generalisation test).
Same percentile=50 split logic as extract_lamellipodia_finetuned.py.

Convention: brighter = lamellipodia (Arp2/3 concentrated at leading edge),
dimmer = cytoplasmic Arp2/3 pool.
"""
import csv
...
CENTERED_DIR = Path('/dcs/pg25/u1898019/Desktop/Categorised_Data_2nd_finetuned')
...
def main():
    ...
    print('\n=== Per-condition summary (2nd batch, brighter = lamellipodia) ===')
